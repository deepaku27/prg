...
add_action( 'tgmpa_register', 'urbanpointwp_register_plugins' );
 ...
 */
function urbanpointwp_register_plugins() {
    /*
    ...
    $plugins = array(
        ...
        array(
            'name'                  => esc_html__('WPBakery Visual Composer', 'urbanpointwp'), // The plugin name
        ...
        array(
            'name'                  => esc_html__('Revolution Slider', 'urbanpointwp'), // The plugin name
        ...
        array(
            'name'                  => esc_html__('Parallax Backgrounds for VC', 'urbanpointwp'), // The plugin name
        ...
        array(
            'name'                  => esc_html__('ModelTheme Framework', 'urbanpointwp'), // The plugin name
            'slug'                  => 'modeltheme-framework', // The plugin slug (typically the folder name)
            'source'                => get_template_directory().'/inc/tgm/plugins/modeltheme-framework-urbanpoint.zip', // The plugin source.
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            'name'                  => esc_html__('Comments Ratings', 'urbanpointwp'), // The plugin name
            'slug'                  => 'comments-ratings', // The plugin slug (typically the folder name)
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ),
        array(
            'name'                  => esc_html__('Redux Framework', 'urbanpointwp'), // The plugin name
            'slug'                  => 'redux-framework', // The plugin slug (typically the folder name)
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ),
        array(
            'name'                  => esc_html__('Contact Form 7', 'urbanpointwp'), // The plugin name
